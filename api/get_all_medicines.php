 ...
 * API Endpoint: Get All Medicines
 *
 * This endpoint reads from db.json and returns all medicines that are in stock.
 */
...
try {
    ...
    // 2. Go through stock batches that have quantity > 0
